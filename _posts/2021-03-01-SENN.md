...
{% capture newpath %}{{ page.img_dir }}{{ "vae.jpeg" }}{% endcapture %} 
{% capture caption %}
<blockquote>
...
{% capture caption %}
<blockquote>
Figure 5: Images sampled from the latent space of the style encoder manipulating a single dimension of the latent space.
</blockquote>
{% endcapture %} 
{% include figure.html src=newpath caption=caption width="400px" %}
